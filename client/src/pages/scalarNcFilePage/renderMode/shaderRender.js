...
export default function shaderRender(viewer, data, header) {
    ...
    */
    ...
    const point1 = Cartesian3.fromDegrees(lonDistance, 0);
    const point2 = Cartesian3.fromDegrees(0, 0);
    const lonDist = computedAbsoluteDistance(point1, point2);
    const point3 = Cartesian3.fromDegrees(0, latDistance);
    const point4 = Cartesian3.fromDegrees(0, 0);
    ...
    data.forEach(item => {
        ...
        const geometry = BoxGeometry.fromDimensions({
            ...
            dimensions: new Cartesian3(lonDist, latDist, height)
        });
...
const computedAbsoluteDistance = (point1, point2) => {
    return Math.abs(Cartesian3.distance(point1, point2));
}